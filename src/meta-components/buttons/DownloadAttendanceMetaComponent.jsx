...
import {fileDownloadHandler} from "../../utilityFunctions/apiHandling";
export const DownloadAttendanceMetaComponent = ({url, children, ...rest}) => {
    return (
        <li {...rest} className={"group/item p-1.5  pl-2 flex flex-row justify-between bg-slate-100 hover:bg-slate-200  text-slate-700 font-medium"}>
            {children}
            <button onClick={() => {fileDownloadHandler(url)}}>
