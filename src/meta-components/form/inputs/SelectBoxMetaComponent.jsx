            ...
            <div className="mt-2">
                <div
                    ...
                    <select  name={name} placeholder={placeholder} {...rest}
                        className="block w-full border-0 bg-transparent py-1.5 pl-1 text-slate-900 placeholder:text-slate-400 focus:ring-0 sm:text-sm sm:leading-6 justify-center">
                        {
